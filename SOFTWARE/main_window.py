...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.lbRxPlat = QtWidgets.QLabel(self.frame_16)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.lbRxPlat.sizePolicy().hasHeightForWidth())
        self.lbRxPlat.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        self.lbRxPlat.setFont(font)
        self.lbRxPlat.setAutoFillBackground(False)
        self.lbRxPlat.setFrameShadow(QtWidgets.QFrame.Plain)
        self.lbRxPlat.setTextFormat(QtCore.Qt.RichText)
        self.lbRxPlat.setObjectName("lbRxPlat")
        self.horizontalLayout_11.addWidget(self.lbRxPlat)
        ...
        self.lbMeasuringBoard = QtWidgets.QLabel(self.frame_25)
        font = QtGui.QFont()
        font.setPointSize(11)
        font.setBold(True)
        font.setWeight(75)
        self.lbMeasuringBoard.setFont(font)
        self.lbMeasuringBoard.setAlignment(QtCore.Qt.AlignCenter)
        self.lbMeasuringBoard.setObjectName("lbMeasuringBoard")
        self.horizontalLayout_17.addWidget(self.lbMeasuringBoard)
        self.comboBoxMeasBoard = QtWidgets.QComboBox(self.frame_25)
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        self.comboBoxMeasBoard.setFont(font)
        self.comboBoxMeasBoard.setObjectName("comboBoxMeasBoard")
        self.horizontalLayout_17.addWidget(self.comboBoxMeasBoard)
        self.pbConnMeasBoard = QtWidgets.QPushButton(self.frame_25)
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        self.pbConnMeasBoard.setFont(font)
        self.pbConnMeasBoard.setObjectName("pbConnMeasBoard")
        self.horizontalLayout_17.addWidget(self.pbConnMeasBoard)
        self.lb_Rx_MeasBoard = QtWidgets.QLabel(self.frame_25)
        self.lb_Rx_MeasBoard.setEnabled(True)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.lb_Rx_MeasBoard.sizePolicy().hasHeightForWidth())
        self.lb_Rx_MeasBoard.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        self.lb_Rx_MeasBoard.setFont(font)
        self.lb_Rx_MeasBoard.setTextFormat(QtCore.Qt.RichText)
        self.lb_Rx_MeasBoard.setObjectName("lb_Rx_MeasBoard")
        self.horizontalLayout_17.addWidget(self.lb_Rx_MeasBoard)
        self.verticalLayout_7.addWidget(self.frame_25)
        self.pbUpdateCOMList = QtWidgets.QPushButton(self.centralwidget)
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        self.pbUpdateCOMList.setFont(font)
        self.pbUpdateCOMList.setObjectName("pbUpdateCOMList")
        self.verticalLayout_7.addWidget(self.pbUpdateCOMList)
        ...
        self.sbXinit.setProperty("value", 3000)
        ...
        self.sbZinit.setProperty("value", 3000)
        ...
        self.sbZmax = QtWidgets.QSpinBox(self.frame_13)
        self.sbZmax.setAlignment(QtCore.Qt.AlignCenter)
        self.sbZmax.setMinimum(1)
        self.sbZmax.setMaximum(36000)
        self.sbZmax.setSingleStep(100)
        self.sbZmax.setProperty("value", 6000)
        self.sbZmax.setObjectName("sbZmax")
        self.horizontalLayout_8.addWidget(self.sbZmax)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lbSerialPort.setText(_translate("MainWindow", "Plataform Serial Port"))
        self.pbConectarSerial.setText(_translate("MainWindow", "Connect"))
        self.lbRxPlat.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" color:#00aa00;\">RX</span></p></body></html>"))
        self.lbMeasuringBoard.setText(_translate("MainWindow", "Measuring Board Port"))
        self.pbConnMeasBoard.setText(_translate("MainWindow", "Connect"))
        self.lb_Rx_MeasBoard.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" color:#00aa00;\">RX</span></p></body></html>"))
        self.pbUpdateCOMList.setText(_translate("MainWindow", "Update COM List"))
        ...
        self.label_5.setText(_translate("MainWindow", "Z final position (um)  "))
